...
declare module orzo {
     ...
     */
    function printf(s:string, ...values:any[]):void;
     ...
     * @param getValue
     */
    function uniq<T, U>(data:Array<U>, getValue?:(v:U)=>T):Array<T>;
    function uniq<T>(data:Array<T>):Array<T>;
